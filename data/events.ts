export const events = [
  {
    id: '1',
    title: 'مؤتمر التقنية المستقبلي 2024',
    title_en: 'Future Tech Conference 2024',
    title_tr: 'Gelecek Teknoloji Konferansı 2024',
  ...
  {
    id: '2',
    title: 'حفل إطلاق رؤية الشركة',
    title_en: 'Company Vision Launch',
    title_tr: 'Şirket Vizyonu Lansmanı',
    ...
    description_tr: 'Öنümüzdeki on yıl için yeni kimliğin ve stratejik vizyonun lansman etkinliğinin belgelenmesi.',
    image: '/images/events/vision-launch.jpg',
    date: '2024-09-20',
    location: 'Dubai, UAE',
    category: 'Corporate'
  },
  {
    id: '3',
    title: 'مهرجان الفنون الدولي',
    title_en: 'International Arts Festival',
    title_tr: 'Uluslararası Sanat Festivali',
    ...
    image: '/images/events/arts-fest.jpg',
    date: '2024-08-05',
    location: 'Riyadh, KSA',
    category: 'Festival'
  },
  {
    ...
    title_en: 'E-Sports Championship',
    title_tr: 'E-Spor Şampiyonası',
