          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
              ...
              {submitStatus === 'success' && (
                <div
                  className="mb-6 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 text-green-700 dark:text-green-400 rounded-lg"
                  role="alert"
                >
              ...
              >
                ...
                <div>
                  <label
                    ...
                    className="block text-sm font-medium text-dark dark:text-gray-300 mb-1"
                  >
