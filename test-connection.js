/**
 * Script بسيط للتحقق من الاتصال بقاعدة البيانات
...
async function testConnection() {
  ...
  try {
    ...
    try {
      ...
      if (error.message.includes('supabaseUserId') || error.message.includes('Unknown column')) {
    ...
    if (error.message.includes('P1001') || error.message.includes("Can't reach")) {
      ...
      console.log('   4. أن Firewall يسمح بالاتصال');
      ...
      console.log('   2. تحقق من أن المستخدم (postgres) موجود');
